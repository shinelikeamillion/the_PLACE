...
<body>
	<div class="main">
		<div class="main-header">
			...
			<nav class="nav">
				<a class="nav-item" id="hot-news" href="">HotNews</a> <a class="nav-item" id="culture"
					href="Knowlage&Culture.html">Knowledge&amp;Culture</a>
				<a class="nav-item" id="stars" href="Stars.html" style="color: #ffffff;">Stars</a> <a class="nav-item"
					id="records" href="Records.jsp">Records</a> <a class="nav-item" id="blog" href="index.jsp">Blog</a>
			</nav>
		</div>
			...
			<div class="flip Y">
				...
				<div class="back">
					<table>
						<tr>
							<th colspan="2">
								<c:out value="${ playerInfo.player_name }" default="Michael Jeffrey Jordan" />
							</th>
						</tr>
						<tr>
							<td>国 籍:</td>
							<td>
								<c:out value="${ playerInfo.player_country }" default="美 国--纽约市布鲁克林区" />
							</td>
						</tr>
						<tr>
							<td>身高:</td>
							<td>
								<c:out value="${ playerInfo.player_height }" default="198.0" />cm</td>
						</tr>
						<tr>
							<td>体重:</td>
							<td>
								<c:out value="${ playerInfo.player_weight }" default="98.1" />KG</td>
						</tr>
						<tr>
							<td>球队:</td>
							<td>
								<c:out value="${ playerInfo.player_team }"
									default="芝加哥公牛（1984-1998），华盛顿奇才（2001-2003）" />
							</td>
						</tr>
						<tr>
							<td>特点:</td>
							<td>
								<c:out value="${ playerInfo.player_specialty }" default="得分、防守、领导力超强" />
							</td>
						</tr>
						<tr>
							<td>生涯:</td>
							<td>
								<c:out value="${ playerInfo.player_prefession }"
									default="6次NBA总冠军 2次奥运会冠军 3次NBA全明星MVP 5次常规赛MVP 6次总决赛MVP" />
							</td>
						</tr>
					</table>
				</div>
		...
		<footer class=" col-sm-12 blog-footer">
			...
			<p>
				<a href="#">the PLACE</a> by <a href="#">@XXX</a>.
			</p>
		</footer>
	</div>
